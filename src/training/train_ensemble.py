...
# ========================================
# 3️⃣ GRID SEARCH POUR CHAQUE MODEL
# ========================================
best_models = {}
...
for model_name, (model, params) in models.items():
    ...
    print(f"\n✅ {model_name} - Meilleurs hyperparamètres: {grid_search.best_params_}")
...
# ========================================
# 4️⃣ ENSEMBLE (VOTING CLASSIFIER)
# ========================================
print("\n🎯 Création d'un Ensemble Voting Classifier...")
...
# ========================================
# 5️⃣ STACKING SIMPLE (MOYENNE PONDÉRÉE)
# ========================================
print("\n🎯 Création d'un Stacking avec moyenne pondérée...")
...
# Moyenne pondérée (poids basés sur F1 scores)
weights = np.array([
...
print(f"\n✅ STACKING PONDÉRÉ (poids: {weights.round(3)})")
...
# ========================================
# 6️⃣ RÉSUMÉ COMPARATIF
# ========================================
print("\n" + "="*70)
print("📊 RÉSUMÉ COMPARATIF DE TOUS LES MODÈLES")
print("="*70)
